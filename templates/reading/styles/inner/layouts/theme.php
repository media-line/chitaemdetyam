	...
	<footer id="tm-footer" class="tm-footer uk-margin-remove">
		<div class="uk-container uk-container-center uk-clearfix">	
			...
			<div class="uk-medialine uk-float-right uk-text-right uk-text-black uk-h6">
				...
				<a class="" rel="nofollow" title="<?php echo JText::_("TPL_COPYRIGHTS_TEXT")." ".JText::_("TPL_COPYRIGHTS_LINK"); ?>" target="_blank" href="http://www.medialine.by"><?php echo JText::_("TPL_COPYRIGHTS_LINK");?></a>
			</div>
		</div>
	</footer>
	<?php endif; ?>
