<div class="uk-text-center uk-text-uppercase uk-bestworks-title"><?php echo JText::_("TPL_TITLE_BESTWORKS"); ?></div>
<div class="uk-position-relative" data-uk-slideset="{default: 3, autoplay: false, animation: 'slide-horizontal', duration: 225}">
<ul class="uk-bestworks jshop uk-grid uk-grid-medium uk-slideset">
<?php 
if (count($rows) > 0)
 foreach($rows as $product){ ?>
	 <li class="">
	 <div class="uk-book-teaser uk-position-relative">
...
<?php 	} ?>
<div class="uk-book-teaser-desc uk-position-absolute">
...
<?php 	print $product->_tmp_var_bottom_foto;?>
		...
		<?php 	if ($product->manufacturer->name){// option modul manufacturer_name ?>
			<div class="uk-teaser-autor uk-h4 uk-text-bold uk-text-center uk-text-black"><span><?php print $product->manufacturer->name?></span></div>
		<?php 	}?>
		
		<div class="uk-slideset-teaser-title uk-margin-top">
            <div class="uk-text-uppercase uk-h2 uk-text-bold uk-text-center uk-text-black" <? /*href="<?php print $product->product_link?>"*/?>><?php print $product->name?></div>
...
<?php 		if ($show_button_detal){?>
            <a class="uk-button uk-button-medium" href="<?php print $product->product_link?>"><?php print _JSHOP_DETAIL?></a>
<?php		}?>
...
<a class="uk-slideset-buttons uk-slideset-prev" href=""data-uk-slideset-item="previous"></a>
<a class="uk-slideset-buttons uk-slideset-next" href=""data-uk-slideset-item="next"></a>
</div>