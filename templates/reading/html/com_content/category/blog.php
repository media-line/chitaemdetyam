...
<div class="uk-grid">
	<div class="uk-width-1-1">
		<div class="uk-panel uk-panel-header">
			...
			<div class="uk-h1 uk-text-bold uk-text-black"><?php echo $this->escape($this->params->get('page_heading')); ?></div>
			<?php endif; ?>

			<?php if ($this->params->get('page_subheading')) : ?>
			<div><?php echo $this->escape($this->params->get('page_subheading')); ?></div>
			<?php endif; ?>

			<?php if ($this->params->get('show_category_title', 1)) : ?>
			<div class="uk-h1"><?php echo $this->category->title;?></div>
			<?php endif; ?>
