            ...
            <li style="min-height: <?php echo $settings['min_height']; ?>px;">
                ...
                <?php if ($item['media'] && $settings['media']) : ?>
                    ...
                    <div class="<?php echo $overlay; ?>">
						...
						<?php if ($item['content'] && $settings['content']) : ?>
							<div class="uk-container uk-container-center uk-position-relative">
								<div class="uk-slide-content uk-position-absolute">
									<div class="uk-slide-text uk-text-hitchhike <?php echo $content_size; ?> uk-margin"><?php echo $item['content']; ?></div>
								</div>
							</div>
						<?php endif; ?>
					...
					<?php if ($item['link'] && $settings['link']) : ?>
						<div class="uk-slide-link uk-text-center uk-width-1-1"><a<?php if($link_style) echo ' class="' . $link_style . '"'; ?> href="<?php echo $item->escape('link'); ?>"<?php echo $link_target; ?>><span><?php echo $app['translator']->trans($settings['link_text']); ?></span></a></div>
					<?php endif; ?>
