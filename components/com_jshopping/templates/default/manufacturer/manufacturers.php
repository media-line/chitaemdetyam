...
<div class="jshop" id="comjshop">
	...
	$remainder = ($rowsCount % 3);
	$firstColumn = $secondColumn = $rowsInColumn = ($rowsCount-$remainder)/3;
	if ($remainder == 1){
    ...
    <div class="jshop_list_manufacturer">
        <div class = "jshop uk-grid">
			...
			foreach($this->rows as $k=>$row) : ?>
				...
				if(($count == $firstColumn) || ($count == $firstColumn + $secondColumn)) echo '</div><div class = "uk-width-1-3">'; 
                $count++;
