...
<div class="jshop productfull" id="comjshop">
    <form class="uk-clearfix" name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="uk-h1 uk-text-bold uk-margin-large-bottom"><?php print $this->product->name?><?php if ($this->config->show_product_code){?> <span class="jshop_code_prod">(<?php print _JSHOP_EAN?>: <span id="product_code"><?php print $this->product->getEan();?></span>)</span><?php }?></div>
        
		<?php foreach($this->product->extra_field as $extra_field){?>
			<?php if ($extra_field['id'] == 7){?>
				<div class="uk-width-1-1 uk-full-bookread">
		...
		<?php if (is_array($this->product->extra_field)){?>
			...
			<?php if ($this->config->product_show_manufacturer && $this->product->manufacturer_info->name!=""){?>
				<div class="uk-grid uk-grid-collapse">
					...
					<div class="uk-width-1-2"><?php print $this->product->manufacturer_info->name?></div>
				</div>
			<?php }?>
            <?php foreach($this->product->extra_field as $extra_field){?>
				<?php if (($extra_field['id'] == 7) || ($extra_field['id'] == 8)){} else{?>
					...
					<div class="extra_fields_el uk-grid uk-grid-collapse">
						<div class="uk-width-1-3"><?php print $extra_field['name'];?>:</div>
		...
		<div class="jshop_prod_description uk-full-description">
