...
<div class="product productitem_<?php print $product->product_id?> uk-grid">
    ...
    <div class="uk-width-2-3 uk-teaser-description">
        ...
        <?php if ($product->manufacturer->name){?>
            <div class="manufacturer_name uk-grid uk-grid-collapse">
                ...
                <div class="uk-width-1-3"><?php print $product->manufacturer->name?></div>
            </div>
        <?php }?>
            ...
            <div class="extra_fields uk-width-1-1 uk-grid uk-grid-collapse">
                <?php foreach($product->extra_field as $extra_field){?>
                    <div class=" uk-width-1-1 uk-grid uk-grid-collapse">
                        ...
                        <div class="data uk-width-1-3"><?php print $extra_field['value'];?></div>
                    </div>
                <?php }?>
            </div>            
        <?php }?>
